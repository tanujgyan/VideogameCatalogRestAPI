...
using VideogameCatalogRestAPI.Repositories.Implementations;
using VideogameCatalogRestAPI.Services.Contracts;
using VideogameCatalogRestAPI.Services.Implementation;
...
namespace VideogameCatalogRestAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "VideogameCatalogRestAPI", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
           ...
           options.WithOrigins("http://localhost:4200").AllowAnyMethod().AllowAnyHeader());
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "VideogameCatalogRestAPI v1"));
            }
